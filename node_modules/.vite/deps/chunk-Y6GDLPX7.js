...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match2, setMatch] = React21.useState(() => {
    if (noSsr && matchMedia) {
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React31.useState(false);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React32.useContext(ColorSchemeContext) || defaultContext;
  function CssVarsProvider(props) {
    ...
    const initialTheme = React32.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React32.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React32.Fragment, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Y6GDLPX7.js.map
